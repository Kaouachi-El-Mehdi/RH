    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.FileField(blank=True, null=True, upload_to='profiles/', verbose_name='Photo de profil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills', models.TextField(blank=True, help_text='Séparez les compétences par des virgules', null=True, verbose_name='Compétences')),
                ('experience_years', models.PositiveIntegerField(default=0, verbose_name="Années d'expérience")),
                ('education_level', models.CharField(blank=True, max_length=100, null=True, verbose_name="Niveau d'études")),
                ('current_position', models.CharField(blank=True, max_length=200, null=True, verbose_name='Poste actuel')),
                ('current_company', models.CharField(blank=True, max_length=200, null=True, verbose_name='Entreprise actuelle')),
